...
class MainMenu:
    def __init__(self):
        ...
        self.highlighted_exit = pygame.image.load("./assets/exitbutton_highlighted.png")#load highlighted exit button
        ...
        self.highlighted_play = pygame.image.load("./assets/play_button_highlighted.png")#load highlihgted play button
        ...
        self.highlighted_settings = pygame.image.load("./assets/settingsbutton_highlighted.png")#load highlihgted settings button
        ...
        self.highlighted_credits = pygame.image.load("./assets/creditsbutton_highlighted.png")#load highlighted credits button
        ...
        self.of_bi = pygame.image.load("./assets/of_bi.png")#load the png of word of in binary
        ...
        self.the_bi_2 = pygame.image.load("./assets/the_bi.png")#load the png of word the in binary
        ...
        self.undead_bi = pygame.image.load("./assets/Undead_bi.png")#load the png of word undead in binary
        ...
        self.undead_bi_2 = pygame.image.load("./assets/undead_bi.png")#load the png of word undead in binary
        ...
        self.initials_bi = pygame.image.load("./assets/GSNJE_bi.png")#load the png of word undead in binary
