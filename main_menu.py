...
class MainMenu:
    ...
    # This function is called over and over in main when game_state is "Main Menu"
    def run(self):
        ...
        if self.code_bi_2_x == 0: # If the 2nd png of the bi image has reached the left side of the screen
            self.code_bi_x = 0 + self.code_bi_2_width # Puts the first image of binary on the end of the 2nd
        else:
        ...
        if self.of_bi_x == 0: # If the first png of the bi image is on the right side of the screen
            self.of_bi_2_x = 0 - self.of_bi_2_width # Puts the second image of binary with its right end on the 0th pixel
        else:
        ...
        if self.the_bi_2_x == 0: # If the 2nd png of the bi image has reached the left side of the screen
            self.the_bi_x = 0 + self.the_bi_2_width #Puts the first image of binary on the end of thet 2nd
        else:
        ...
        if self.the_bi_x == 0: # If the first png of the bi image is on the left side of the screen
            self.the_bi_2_x = 0 + self.the_bi_width # Puts the second image of binary on the end of the first
        else:
        ...
        if self.undead_bi_2_x == 0: # If the 2nd png of the bi image has reached the left side of the screen
            self.undead_bi_x = 0 + self.undead_bi_2_width # Puts the first image of binary on the end of thet 2nd
        else:
        ...
        if self.undead_bi_x == 0: # If the first png of the bi image is on the left side of the screen
            self.undead_bi_2_x = 0 + self.undead_bi_width # Puts the second image of binary on the end of the first
        else:
        ...
        if self.initials_bi_2_x == 0: # If the 2nd png of the bi image has reached the right side of the screen
            self.initials_bi_x = 0 - self.initials_bi_width # Puts the first image of binary with its right end on the 0th pixel
        else:
        ...
        if self.initials_bi_x == 0: # If the first png of the bi image is on the right side of the screen
            self.initials_bi_2_x = 0 - self.initials_bi_2_width # Puts the second image of binary with its right end on the 0th pixel
        else:
        ...
        self.display_surface.blit(self.credits_button, self.credits_button_pos) # Draws the credits button
        ...
        ((mouse_pos[1] > self.exit_button_pos[1]) and (mouse_pos[1] < (self.exit_button_pos[1] + self.exit_button_height))):
            ...
            if mouse_state[0] == True: # If left button is clicked it quits and exits the game
                ...
                return "Main Menu" # If the button is not clicked it returns Main Menu -- the main menu game_state
        else:
            return "Main Menu" # Returns Main Menu game_state -- runs if no button is clicked
